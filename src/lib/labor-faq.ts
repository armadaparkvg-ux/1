...
export const LABOR_FAQ = [
  ...
  },
  {
    ...
    a: "Поможем внести автомобиль в реестр такси ФГИС — 3 500 ₽ на 5 лет. Напишите в чат, пришлите фото авто и СТС с двух сторон, дождитесь документа 1–3 дня по региону, проверьте и оплатите.",
  },
  {
