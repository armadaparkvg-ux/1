...
const REQUIREMENTS = [
  ...
  "Для лицензии ФГИС: фото авто и СТС с двух сторон, оплата 3 500 ₽ после проверки",
];
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          <FadeIn>
            <SectionHeading
              ...
              align="left"
              eyebrow="Оформление"
              title="Условия подключения водителей в таксопарк «Армада»"
              description="Требования для легального подключения к Яндекс Такси: документы, стаж, автомобиль. Подготовим и проверим пакет вместе с вами."
            />
          </FadeIn>
