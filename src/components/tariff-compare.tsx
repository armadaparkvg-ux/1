...
const ROWS = [
  ...
  },
  {
    ...
    ip: "Лимит НПД / быстрый вывод",
    labor: "Банкротство, пособия, проверки",
  },
] as const;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <SectionHeading
            ...
            description="Коротко: самозанятый — проще и дешевле; ИП — моментальный вывод; трудовой — официально, налоги платит парк."
          />
        </FadeIn>
