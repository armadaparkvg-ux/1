...
const CONTENT = {
  license: {
    ...
    description:
      "Напишите в чат, пришлите фото авто и СТС с двух сторон, дождитесь документа 1–3 дня по региону, проверьте и оплатите 3 500 ₽.",
    price: "3 500 ₽",
    priceHint: "на 5 лет",
    icon: FileCheck2,
    ...
    points: [
      "Написать в чат MAX или Telegram",
      "Фото автомобиля и СТС с двух сторон",
      "Готовый документ от 1 до 3 дней — по региону подачи",
      "Проверка записи, затем оплата 3 500 ₽",
    ],
