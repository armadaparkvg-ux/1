...
const SERVICES: {
...
}[] = [
  {
    ...
    description:
      "Выписка ФГИС на авто: напишите в чат, пришлите фото машины и СТС с двух сторон, дождитесь документа 1–3 дня по региону, проверьте и оплатите 3 500 ₽ на 5 лет.",
    docs: "Процесс: чат → фото авто и СТС с двух сторон → ожидание 1–3 дня → проверка → оплата 3 500 ₽.",
