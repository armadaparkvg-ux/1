...
export const metadata: Metadata = {
  ...
  description: `Публичная оферта ${SITE.fullName}`,
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-5 text-sm leading-relaxed text-muted-foreground">
        ...
        <p>
          Акцептом оферты считается отправка заявки через форму на сайте либо
          обращение по телефону / в мессенджерах с последующим согласованием
          условий менеджером парка.
        </p>
        <p>
